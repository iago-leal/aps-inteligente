...
| Métrica | Valor |
|---------|-------|
| Total de ações | 52 · **16 concluídas** (T001–T006 da Preparação; a cadeia do gerador, T029 a T033; a leitura do dado com o seu apoio e o seu teste — T020, T034, T007, T011; e os casos-oráculo congelados, T008) |
| Paralelizáveis (`[//]`) | 27 |

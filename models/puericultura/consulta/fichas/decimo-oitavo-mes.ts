// Consulta do 18.º Mês, transcrita da p. 73 da Caderneta da Criança (feature 020, T024).
// Divide a página com a do 12.º Mês e difere dela em dois pontos, ambos da fonte: a pergunta
// da alimentação é "O que a criança está comendo?", e o tremor vem no singular.
...
export const DECIMO_OITAVO_MES: Ficha = {
  id: "decimo-oitavo-mes",
  titulo: "Consulta do 18º Mês",
  pagina: PAGINA,
  faixaEmDias: { de: 548, ate: 729 },
  secoes: [
    secao(1, "Medidas", [
      medida({
